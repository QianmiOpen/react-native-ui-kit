...
import {StyleSheet, View, PixelRatio, Image, Text} from 'react-native';
        ...
        return (
            <BtnContainer
                ...
                <View style={styles.row}>
                    {this.props.image ? <Image style={[styles.rowImg, imageStyle]} source={this.props.image}/> : this.props.imageRender()}
                    {this._renderTitle()}
                </View>
